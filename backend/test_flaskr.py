...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgres://{}:{}@{}/{}".format('postgres', 'twin8693','localhost:5432', self.database_name)
    ...
    def test_404_search_question_not_found(self):
        res = self.client().post('/questions', json={'searchTerm': 'abc'})
        data = json.loads(res.data)
    ...
    def test_get_categoryQuestions(self):
    ...
    def test_get_quizQuestion(self):
